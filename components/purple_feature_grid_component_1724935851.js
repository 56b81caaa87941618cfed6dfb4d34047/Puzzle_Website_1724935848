        ...
        <div id="feature-1">
            <div id="feature-1-header" class="flex items-center space-x-2 mb-1">
               ...
               <div class="flex" id="feature-1-title-container">
                    <h4 id="feature-1-title" class="flex-1 text-slate-50 font-medium">Endless Variety</h4>
                </div>
            </div>
            <div class="flex" id="feature-1-description-container">
                <p id="feature-1-description" class="flex-1 text-sm">Explore a vast collection of puzzles, from jigsaw to crosswords, sudoku to riddles, catering to all skill levels and preferences.</p>
            </div>
        </div>
        ...
        <div id="feature-2">
            <div id="feature-2-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-2-title-container">
                    <h4 id="feature-2-title" class="flex-1 text-slate-50 font-medium">Brain-Boosting Fun</h4>
                </div>
            </div>
            <div class="flex" id="feature-2-description-container">
                <p id="feature-2-description" class="flex-1 text-sm">Sharpen your mind and improve cognitive skills while enjoying our carefully curated selection of engaging puzzles.</p>
            </div>
        </div>
        ...
        <div id="feature-3">
            <div id="feature-3-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-3-title-container">
                    <h4 id="feature-3-title" class="flex-1 text-slate-50 font-medium">Daily Challenges</h4>
                </div>
            </div>
            <div class="flex" id="feature-3-description-container">
                <p id="feature-3-description" class="flex-1 text-sm">Test your puzzle-solving prowess with our daily featured puzzles, designed to keep you coming back for more.</p>
            </div>
        </div>
        ...
        <div id="feature-4">
            <div id="feature-4-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-4-title-container">
                    <h4 id="feature-4-title" class="flex-1 text-slate-50 font-medium">Community Connection</h4>
                </div>
            </div>
            <div class="flex" id="feature-4-description-container">
                <p id="feature-4-description" class="flex-1 text-sm">Join a vibrant community of puzzle enthusiasts, share strategies, and compete in friendly tournaments.</p>
            </div>
        </div>
        ...
        <div id="feature-5">
            <div id="feature-5-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-5-title-container">
                    <h4 id="feature-5-title" class="flex-1 text-slate-50 font-medium">Personalized Experience</h4>
                </div>
            </div>
            <div class="flex" id="feature-5-description-container">
                <p id="feature-5-description" class="flex-1 text-sm">Tailor your puzzle journey with customizable difficulty settings and personalized recommendations based on your preferences.</p>
            </div>
        </div>
        ...
        <div id="feature-6">
            <div id="feature-6-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-6-title-container">
                    <h4 id="feature-6-title" class="flex-1 text-slate-50 font-medium">Create and Share</h4>
                </div>
            </div>
            <div class="flex" id="feature-6-description-container">
                <p id="feature-6-description" class="flex-1 text-sm">Unleash your creativity by designing your own puzzles and sharing them with fellow enthusiasts in our puzzle marketplace.</p>
            </div>
        </div>
    </div>
</template>
